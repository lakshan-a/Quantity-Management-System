...
'categories_subtitle': 'Manage your categories, organize products, and track performance.',
    ...
    si: {
        ...
        'categories_title': 'ප්‍රවර්ග කළමනාකරණය',
'categories_subtitle': 'ඔබගේ ප්‍රවර්ග කළමනාකරණය කරන්න, නිෂ්පාදන සංවිධානය කරන්න, සහ කාර්ය සාධනය නිරීක්ෂණය කරන්න.',
        'search_placeholder': 'ප්‍රවර්ග සොයන්න...',
        'add_category_btn': 'ප්‍රවර්ගය එකතු කරන්න',
        'table_header_id': 'ප්‍රවර්ග හැඳුනුම්පත',
        'table_header_name': 'ප්‍රවර්ග නම',
        'table_header_created': 'සාදන ලද්දේ',
        'table_header_actions': 'ක්‍රියා',
        'no_categories_found': 'ප්‍රවර්ග හමු නොවිණි',
        'add_category_title': 'ප්‍රවර්ගය එකතු කරන්න',
        ...
        'category_name_placeholder': 'උදා: ඉලෙක්ට්‍රොනික්ස්, ඇඳුම් ...',
        'cancel_btn': 'අවලංගු කරන්න',
        'save_btn': 'සුරකින්න',
        'delete_title': 'ප්‍රවර්ගය මකන්න',
        'delete_confirmation_msg': 'ඔබට මෙම ප්‍රවර්ගය මකා දැමීමට අවශ්‍ය බව විශ්වාසද? මෙම ක්‍රියාව ආපසු හැරවිය නොහැක.',
        'delete_btn': 'මකන්න',
        'view': 'බලන්න',
        'edit': 'සංස්කරණය',
        'delete': 'මකන්න'
    ...
    ta: {
        ...
        'categories_title': 'வகை மேலாண்மை',
'categories_subtitle': 'உங்கள் வகைகளை நிர்வகிக்கவும், தயாரிப்புகளை ஒழுங்கமைக்கவும், செயல்திறனைக் கண்காணிக்கவும்.',
        'search_placeholder': 'வகைகளைத் தேடுக...',
        'add_category_btn': 'வகையைச் சேர்',
        'table_header_id': 'வகை ஐடி',
        ...
        'edit_category_title': 'வகையைத் திருத்துக',
        'form_category_id': 'வகை ஐடி',
        ...
        'save_btn': 'சேமி',
        'delete_title': 'வகையை நீக்குக',
        'delete_confirmation_msg': 'இந்த வகையை நீக்க விரும்புகிறீர்களா? இந்த செயலை மீளமுடியாது.',
        'delete_btn': 'நீக்குக',
        'view': 'பார்க்க',
        'edit': 'திருத்துக',
        'delete': 'நீக்குக'
