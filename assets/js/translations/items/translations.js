...
const translations = {
    en: {
       // ==================== SIDEBAR NAVIGATION ====================
        ...
        'new_product_type_placeholder': 'New product type (e.g., \'Sportswear\')',
        'add_type_btn': 'Add Type',
        'product_type_helper': 'Select an existing type or write a new one and click \'Add Type\'.',
        'sizes_quantities_title': 'Sizes & Quantities',
        'size_placeholder': 'e.g., 2XL, 42, Large',
        'qty_placeholder': 'Qty',
        'add_size_btn': 'Add Size',
        'quick_standard_sizes': 'Quick standard sizes:',
        'selected_sizes_label': 'Selected sizes & quantities:',
        'no_sizes_selected': 'No sizes selected. Click any size chip above or add custom.',
        'size_helper_text': 'Click on any size chip to include/exclude it. Adjust quantity for each included size.',
        'form_colors': 'Colors',
        ...
        'wholesale_id_label': 'Wholesaler ID',
    ...
    si: {
        ...
        'form_product_type': 'නිෂ්පාදන වර්ගය',
        'new_product_type_placeholder': 'නව නිෂ්පාදන වර්ගය (උදා: \'ක්‍රීඩා ඇඳුම්\')',
        'add_type_btn': 'වර්ගය එකතු කරන්න',
        'product_type_helper': 'පවතින වර්ගයක් තෝරන්න හෝ නව එකක් ලියා \'වර්ගය එකතු කරන්න\' ක්ලික් කරන්න.',
        'sizes_quantities_title': 'ප්‍රමාණ සහ ප්‍රමාණ',
        'size_placeholder': 'උදා: 2XL, 42, විශාල',
        'qty_placeholder': 'ප්‍රමාණය',
        'add_size_btn': 'ප්‍රමාණය එකතු කරන්න',
        'quick_standard_sizes': 'ඉක්මන් සම්මත ප්‍රමාණ:',
        'selected_sizes_label': 'තෝරාගත් ප්‍රමාණ සහ ප්‍රමාණ:',
        'no_sizes_selected': 'ප්‍රමාණ කිසිවක් තෝරාගෙන නැත. ඉහත ඕනෑම ප්‍රමාණ චිපයක් ක්ලික් කරන්න හෝ අභිරුචි එකක් එකතු කරන්න.',
        'size_helper_text': 'ඇතුළත් කිරීමට/බැහැර කිරීමට ඕනෑම ප්‍රමාණ චිපයක් ක්ලික් කරන්න. ඇතුළත් කළ එක් එක් ප්‍රමාණය සඳහා ප්‍රමාණය සකසන්න.',
        'form_colors': 'වර්ණ',
    ...
    ta: {
        ...
        'form_product_type': 'தயாரிப்பு வகை',
        'new_product_type_placeholder': 'புதிய தயாரிப்பு வகை (எ.கா: \'விளையாட்டு உடை\')',
        'add_type_btn': 'வகையைச் சேர்',
        'product_type_helper': 'ஏற்கனவே உள்ள வகையைத் தேர்ந்தெடுக்கவும் அல்லது புதியதை எழுதி \'வகையைச் சேர்\' என்பதைக் கிளிக் செய்யவும்.',
        'sizes_quantities_title': 'அளவுகள் மற்றும் அளவுகள்',
        'size_placeholder': 'எ.கா: 2XL, 42, பெரியது',
        'qty_placeholder': 'அளவு',
        'add_size_btn': 'அளவைச் சேர்',
        'quick_standard_sizes': 'விரைவான நிலையான அளவுகள்:',
        'selected_sizes_label': 'தேர்ந்தெடுக்கப்பட்ட அளவுகள் மற்றும் அளவுகள்:',
        'no_sizes_selected': 'அளவுகள் எதுவும் தேர்ந்தெடுக்கப்படவில்லை. மேலே உள்ள எந்த அளவு சிப்பையும் கிளிக் செய்யவும் அல்லது தனிப்பயன் ஒன்றைச் சேர்க்கவும்.',
        'size_helper_text': 'எந்த அளவு சிப்பையும் கிளிக் செய்வதன் மூலம் சேர்க்க/விலக்கலாம். சேர்க்கப்பட்ட ஒவ்வொரு அளவிற்கும் அளவை சரிசெய்யவும்.',
