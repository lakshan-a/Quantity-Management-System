...
const translations = {
    en: {
       // ==================== SIDEBAR NAVIGATION ====================
        ...
        'recent_orders_subtitle': 'Latest 5 orders from your store',
        'col_order': 'Order',
        'col_customer': 'Customer',
        'col_amount': 'Amount',
        'col_status': 'Status',
        'order_status_title': 'Order Status Distribution',
        'order_status_subtitle': 'Breakdown of all orders by status',
    ...
    si: {
        ...
        'dashboard_subtitle': 'අද ඔබගේ ව්‍යාපාරයේ සිදුවන්නේ කුමක්ද යන්න මෙන්න.',
        'recent_orders_title': 'මෑත ඇණවුම්',
        'recent_orders_subtitle': 'ඔබගේ වෙළඳසැලෙන් නවතම ඇණවුම් 5',
        'col_order': 'ඇණවුම',
        'col_customer': 'පාරිභෝගික',
        'col_amount': 'මුදල',
        'col_status': 'තත්වය',
        'order_status_title': 'ඇණවුම් තත්ව බෙදාහැරීම',
        'order_status_subtitle': 'තත්වය අනුව සියලුම ඇණවුම් බිඳවැටීම',
        'vs_last_month': 'පසුගිය මාසයට සාපේක්ෂව',
        'total_orders': 'සම්පූර්ණ ඇණවුම්',
        'todays_orders': 'අද දින ඇණවුම්',
        'pending_orders': 'විසඳුම් නොකළ ඇණවුම්',
        'delivered_orders': 'භාරදුන් ඇණවුම්',
        'returned_orders': 'ආපසු ලබාදුන් ඇණවුම්',
        'total_customers': 'සම්පූර්ණ පාරිභෝගිකයින්',
        'low_stock_items': 'අඩු තොග අයිතම',
        'damaged_items': 'හානි වූ අයිතම',
        'total_revenue': 'සම්පූර්ණ ආදායම',
        'pending': 'විසඳුම් නොකළ',
        'processing': 'සැකසෙමින්',
        'shipped': 'නැව්ගත කරන ලදී',
        'delivered': 'භාරදෙන ලදී',
        'returned': 'ආපසු ලබාදෙන ලදී',
        'orders': 'ඇණවුම්'
    ...
    ta: {
        ...
        'dashboard_subtitle': 'இன்று உங்கள் வணிகத்தில் என்ன நடக்கிறது என்பது இங்கே.',
        'recent_orders_title': 'சமீபத்திய ஆர்டர்கள்',
        'recent_orders_subtitle': 'உங்கள் கடையிலிருந்து சமீபத்திய 5 ஆர்டர்கள்',
        'col_order': 'ஆர்டர்',
        'col_customer': 'வாடிக்கையாளர்',
        'col_amount': 'தொகை',
        'col_status': 'நிலை',
        'order_status_title': 'ஆர்டர் நிலை விநியோகம்',
        'order_status_subtitle': 'நிலை வாரியாக அனைத்து ஆர்டர்களின் முறிவு',
