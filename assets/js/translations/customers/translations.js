...
const translations = {
    ...
    si: {
        ...
        'search_placeholder': 'නම, විද්‍යුත් තැපෑල, දුරකථනය හෝ හැඳුනුම්පත අනුව සොයන්න...',
        'add_customer_btn': 'පාරිභෝගිකයෙක් එකතු කරන්න',
        ...
        'add_customer_title': 'පාරිභෝගිකයෙක් එකතු කරන්න',
        ...
        'delete_confirmation_msg': 'ඔබට මෙම පාරිභෝගිකයා මකා දැමීමට අවශ්‍ය බව විශ්වාසද? මෙම ක්‍රියාව ආපසු හැරවිය නොහැක.',
        'delete_btn': 'මකන්න',
        'view': 'බලන්න',
        'edit': 'සංස්කරණය',
        'delete': 'මකන්න',
        ...
        'notes_label': 'සටහන්',
        'no_customers_found': 'පාරිභෝගිකයින් හමු නොවිණි'
