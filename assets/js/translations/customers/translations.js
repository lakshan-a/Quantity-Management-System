...
const translations = {
    en: {
       // ==================== SIDEBAR NAVIGATION ====================
        ...
        'blocked_customers_title': 'Blocked Customers',
        'table_header_blocked_date': 'Blocked Date',
        ...
        'notes_label': 'Notes',
        'status_label': 'Status',
        'blocked_date_label': 'Blocked Date',
        'no_customers_found': 'No customers found',
        'no_blocked_customers': 'No blocked customers',
        'please_fill_required': 'Please fill in name, phone and email',
        'customer_blocked_success': 'Customer has been blocked.',
        'customer_unblocked_success': 'Customer has been unblocked.'
    },
    si: {
        ...
        'customers_title': 'පාරිභෝගිකයන්',
        'customers_subtitle': 'ඔබගේ පාරිභෝගික පදනම කළමනාකරණය කරන්න, ඇණවුම් බලන්න, සහ නියැලීම් නිරීක්ෂණය කරන්න',
        'search_placeholder': 'නම, විද්‍යුත් තැපෑල, දුරකථන හෝ ID අනුව සොයන්න...',
        'add_customer_btn': 'පාරිභෝගික එකතු කරන්න',
        ...
        'blocked_customers_title': 'අවහිර කළ පාරිභෝගිකයන්',
        'table_header_blocked_date': 'අවහිර කළ දිනය',
        'add_customer_title': 'පාරිභෝගික එකතු කරන්න',
        'edit_customer_title': 'පාරිභෝගික සංස්කරණය කරන්න',
        ...
        'delete_title': 'පාරිභෝගික මකන්න',
        'delete_confirmation_msg': 'ඔබට මෙම පාරිභෝගික මකා දැමීමට අවශ්‍ය බව විශ්වාසද? මෙම ක්‍රියාව ආපසු හැරවිය නොහැක.',
        'delete_btn': 'මකන්න',
        'view': 'බලන්න',
        'edit': 'සංස්කරණය',
        'delete': 'මකන්න',
        'block': 'අවහිර කරන්න',
        'unblock': 'අවහිරය ඉවත් කරන්න',
        'block_customer': 'පාරිභෝගික අවහිර කරන්න',
        'unblock_customer': 'පාරිභෝගික අවහිරය ඉවත් කරන්න',
        'active': 'සක්‍රිය',
        'blocked': 'අවහිර කළ',
        'customer_id_label': 'පාරිභෝගික හැඳුනුම්පත',
        'full_name_label': 'සම්පූර්ණ නම',
        'phone_label': 'දුරකථනය',
        'email_label': 'විද්‍යුත් තැපෑල',
        'city_label': 'නගරය',
        'district_label': 'දිස්ත්‍රික්කය',
        'postal_code_label': 'තැපැල් කේතය',
        'address_label': 'ලිපිනය',
        'notes_label': 'සටහන්',
        'status_label': 'තත්වය',
        'blocked_date_label': 'අවහිර කළ දිනය',
        'no_customers_found': 'පාරිභෝගිකයන් හමු නොවිණි',
        'no_blocked_customers': 'අවහිර කළ පාරිභෝගිකයන් නැත',
        'please_fill_required': 'කරුණාකර නම, දුරකථන අංකය සහ විද්‍යුත් තැපෑල පුරවන්න',
        'customer_blocked_success': 'පාරිභෝගික අවහිර කර ඇත.',
        'customer_unblocked_success': 'පාරිභෝගික අවහිරය ඉවත් කර ඇත.'
    ...
    ta: {
        ...
        'search_placeholder': 'பெயர், மின்னஞ்சல், தொலைபேசி அல்லது ஐடி மூலம் தேடுக...',
        ...
        'blocked_customers_title': 'தடுக்கப்பட்ட வாடிக்கையாளர்கள்',
        'table_header_blocked_date': 'தடுக்கப்பட்ட தேதி',
        'add_customer_title': 'வாடிக்கையாளரைச் சேர்',
        'edit_customer_title': 'வாடிக்கையாளரைத் திருத்துக',
        ...
        'delete_title': 'வாடிக்கையாளரை நீக்குக',
        'delete_confirmation_msg': 'இந்த வாடிக்கையாளரை நீக்க விரும்புகிறீர்களா? இந்த செயலை மீளமுடியாது.',
        'delete_btn': 'நீக்குக',
        'view': 'பார்க்க',
        'edit': 'திருத்துக',
        'delete': 'நீக்குக',
        ...
        'block_customer': 'வாடிக்கையாளரைத் தடு',
        'unblock_customer': 'வாடிக்கையாளர் தடையை நீக்கு',
        'active': 'செயலில்',
        'blocked': 'தடுக்கப்பட்டது',
        'customer_id_label': 'வாடிக்கையாளர் ஐடி',
        'full_name_label': 'முழு பெயர்',
        'phone_label': 'தொலைபேசி',
        'email_label': 'மின்னஞ்சல்',
        'city_label': 'நகரம்',
        'district_label': 'மாவட்டம்',
        'postal_code_label': 'அஞ்சல் குறியீடு',
        'address_label': 'முகவரி',
        'notes_label': 'குறிப்புகள்',
        'status_label': 'நிலை',
        'blocked_date_label': 'தடுக்கப்பட்ட தேதி',
        'no_customers_found': 'வாடிக்கையாளர்கள் எதுவும் கிடைக்கவில்லை',
        'no_blocked_customers': 'தடுக்கப்பட்ட வாடிக்கையாளர்கள் இல்லை',
        'please_fill_required': 'தயவுசெய்து பெயர், தொலைபேசி எண் மற்றும் மின்னஞ்சலை நிரப்பவும்',
        'customer_blocked_success': 'வாடிக்கையாளர் தடுக்கப்பட்டார்.',
        'customer_unblocked_success': 'வாடிக்கையாளர் தடை நீக்கப்பட்டார்.'
