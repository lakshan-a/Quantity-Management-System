...
const translations = {
    en: {
       // ==================== SIDEBAR NAVIGATION ====================
        ...
        'users_subtitle': 'Control user access, manage roles, and monitor team activity across your business.',
        'search_users_placeholder': 'Search by name, email or ID...',
        ...
        'delete_confirmation_msg': 'Are you sure you want to delete this user? This action cannot be undone.',
        'delete_btn': 'Delete',
    ...
    si: {
        ...
        'users_subtitle': 'පරිශීලක ප්‍රවේශය පාලනය කරන්න, භූමිකා කළමනාකරණය කරන්න, සහ ඔබගේ ව්‍යාපාරය පුරා කණ්ඩායම් ක්‍රියාකාරකම් නිරීක්ෂණය කරන්න.',
        'search_users_placeholder': 'නම, විද්‍යුත් තැපෑල හෝ ID අනුව සොයන්න...',
        'add_user_btn': 'පරිශීලක එකතු කරන්න',
        ...
        'col_status': 'තත්වය',
        'col_actions': 'ක්‍රියා',
        'no_users_found': 'පරිශීලකයන් හමු නොවිණි',
        'add_user_title': 'පරිශීලක එකතු කරන්න',
        'edit_user_title': 'පරිශීලක සංස්කරණය කරන්න',
        ...
        'form_profile_image': 'පැතිකඩ පින්තූරය',
        'upload_btn': 'උඩුගත කරන්න',
        'remove_image': 'පින්තූරය ඉවත් කරන්න',
        'form_password': 'මුරපදය',
        'password_placeholder': '••••••••',
        'cancel_btn': 'අවලංගු කරන්න',
        'save_btn': 'සුරකින්න',
        'user_details_title': 'පරිශීලක විස්තර',
        'close_btn': 'වසන්න',
        'delete_title': 'පරිශීලක මකන්න',
        'delete_confirmation_msg': 'ඔබට මෙම පරිශීලක මකා දැමීමට අවශ්‍ය බව විශ්වාසද? මෙම ක්‍රියාව ආපසු හැරවිය නොහැක.',
        'delete_btn': 'මකන්න',
        'view_details': 'විස්තර බලන්න',
        'edit_user': 'පරිශීලක සංස්කරණය',
        'delete_user': 'පරිශීලක මකන්න',
        'user_id_label': 'පරිශීලක හැඳුනුම්පත',
        'full_name_label': 'සම්පූර්ණ නම',
        'email_label': 'විද්‍යුත් තැපෑල',
        'phone_label': 'දුරකථනය',
        'role_label': 'භූමිකාව',
        'status_label': 'තත්වය',
        'created_at_label': 'සාදන ලද්දේ',
    ...
    ta: {
        ...
        'users_title': 'பயனர்கள் மேலாண்மை',
        'users_subtitle': 'பயனர் அணுகலைக் கட்டுப்படுத்தவும், பாத்திரங்களை நிர்வகிக்கவும், உங்கள் வணிகம் முழுவதும் குழுச் செயல்பாட்டைக் கண்காணிக்கவும்.',
        'search_users_placeholder': 'பெயர், மின்னஞ்சல் அல்லது ஐடி மூலம் தேடுக...',
        'add_user_btn': 'பயனரைச் சேர்',
        'col_user_id': 'பயனர் ஐடி',
        'col_user': 'பயனர்',
        'col_phone': 'தொலைபேசி',
        'col_role': 'பாத்திரம்',
        'col_status': 'நிலை',
        ...
        'add_user_title': 'பயனரைச் சேர்',
        'edit_user_title': 'பயனரைத் திருத்துக',
        ...
        'form_profile_image': 'சுயவிவரப் படம்',
        'upload_btn': 'பதிவேற்றுக',
        'remove_image': 'படத்தை அகற்றுக',
        'form_password': 'கடவுச்சொல்',
        'password_placeholder': '••••••••',
        'cancel_btn': 'ரத்து செய்',
        'save_btn': 'சேமி',
        'user_details_title': 'பயனர் விவரங்கள்',
        'close_btn': 'மூடு',
        'delete_title': 'பயனரை நீக்குக',
        'delete_confirmation_msg': 'இந்த பயனரை நீக்க விரும்புகிறீர்களா? இந்த செயலை மீளமுடியாது.',
        'delete_btn': 'நீக்குக',
        'view_details': 'விவரங்களைக் காண்க',
        'edit_user': 'பயனரைத் திருத்துக',
        'delete_user': 'பயனரை நீக்குக',
        ...
        'status_label': 'நிலை',
        'created_at_label': 'உருவாக்கப்பட்டது',
