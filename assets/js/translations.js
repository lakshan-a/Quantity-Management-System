...
const translations = {
    en: {
        ...
        'search_damages': 'Search by item or reason...',
        ...
        'actions': 'Actions',
        'no_damages_found': 'No damaged records found.',
        'item_required': 'Item *',
        'select_item': 'Select item',
        'quantity_required': 'Quantity *',
        'reason_required': 'Reason *',
        'reported_by_required': 'Reported by *',
        'cancel': 'Cancel',
        'delete_damage_record': 'Delete Damage Record',
        'delete_confirmation_message': 'Are you sure you want to delete the damage record for',
        'delete_confirmation_warning': 'This action cannot be undone.',
        'delete': 'Delete',
        'damage_details': 'Damage Details',
        'damaged_item': 'Damaged Item',
        'close': 'Close',
        'edit_damage': 'Edit Damage Report',
        'update_damage': 'Update Damage',
        'item_code_prefix': 'Item Code:',
        'alert_select_item': 'Please select an item',
        'alert_valid_quantity': 'Please enter a valid quantity',
        'alert_enter_reason': 'Please enter a reason',
        'alert_enter_reporter': 'Please enter reporter name',
        'mobile_view': 'View',
        'mobile_edit': 'Edit',
