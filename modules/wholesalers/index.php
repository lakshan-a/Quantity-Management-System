...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div>
        <h1 class="text-2xl md:text-3xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 dark:from-gray-200 dark:to-gray-400 bg-clip-text text-transparent" data-i18n="wholesalers_title">Wholesalers Management</h1>
        <p class="text-gray-500 dark:text-gray-400 text-sm mt-1" data-i18n="wholesalers_subtitle">Manage your wholesalers, organize products, and track performance.</p>
    </div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="relative w-full sm:w-72">
                ...
                <input type="text" id="searchInput" data-i18n-placeholder="search_placeholder" placeholder="Search wholesalers..." 
