...
<div>
    ...
    <p class="text-gray-500 dark:text-gray-400 text-sm mt-1" data-i18n="payments_subtitle">Manage payments securely, track transactions, and monitor cash flow in real time.</p>
</div>
