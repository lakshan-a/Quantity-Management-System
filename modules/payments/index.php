...
<script src="../../assets/script/translations.js"></script>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8 space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5">
        <div class="flex items-start justify-between">
          <div>
            <p class="text-sm font-medium text-slate-500 dark:text-slate-400">COD Payments</p>
      ...
      <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5">
        <div class="flex items-start justify-between">
          <div>
            <p class="text-sm font-medium text-slate-500 dark:text-slate-400">Bank Transfers</p>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <table class="w-full">
          <thead>
            <tr class="border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/60">
              <th class="px-4 py-3 text-left text-xs font-semibold text-slate-500 uppercase">Payment ID</th>
      ...
      <div id="emptyMessage" class="hidden text-center py-12 text-slate-500 dark:text-slate-400">No payments found.</div>
    </div>
  </div>
    ...
    <div class="fixed inset-0 flex flex-col sm:items-center sm:justify-center sm:p-4">
      ...
      <div class="relative w-full bg-white dark:bg-slate-800 shadow-xl rounded-t-2xl sm:rounded-xl sm:max-w-lg max-h-[90vh] overflow-hidden">
        <div class="flex items-center justify-between p-4 border-b border-slate-200 dark:border-slate-700">
          ...
          <h2 class="text-lg font-semibold text-slate-900 dark:text-white pt-2 sm:pt-0">Payment Details</h2>
    ...
    <div class="fixed inset-0 flex flex-col sm:items-center sm:justify-center sm:p-4">
        ...
        <div class="relative w-full bg-white dark:bg-slate-800 shadow-xl rounded-t-2xl sm:rounded-xl sm:max-w-md overflow-hidden">
            <div class="p-6">
                ...
                <h3 class="text-lg font-semibold text-center text-slate-900 dark:text-white mb-2">Delete Payment</h3>
                <p class="text-center text-slate-500 dark:text-slate-400 mb-6">Are you sure you want to delete this payment? This action cannot be undone.</p>
