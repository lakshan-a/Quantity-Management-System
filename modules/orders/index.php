      ...
      <div class="p-4 overflow-y-auto max-h-[calc(80vh-140px)]" id="orderFormContainer">
        <form id="orderForm" class="space-y-6">
          ...
          <div>
            ...
            <div class="relative">
              <input type="text" id="business_name_input" autocomplete="off" placeholder="Search business name..." class="w-full px-3 py-2.5 rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
...
<script>
  ...
  // Business data array (for "New Order From" field)
  let businesses = [
  ...
  function setupBusinessSearch() {
    ...
    document.addEventListener('click', function(e) {
      if (!businessInput.contains(e.target) && !searchResults.contains(e.target)) {
        searchResults.classList.add('hidden');
      }
    });
  }
  ...
  function saveOrder() {
    ...
    if (!businessId) { 
      alert('Please search and select a business name'); 
      return; 
    }
